<?php include "header.php";?>
        <div class = "container-fluid mt-2 mt-5 row" id = "display_row">
            <div class="card shadow p-2 mt-2" id = "card-transform" style="width: 18rem;">
                  <img src="IMG\fruits.jpg" class="card-img-top" height = "195" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Fruits</h5>
                    <a href="db.php?fruits" class="btn button btn button-warning">Buy Now</a>
                  </div>
            </div>
            <div class="card shadow p-2 mt-2" id = "card-transform" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="db.php?vegetables" class="btn button btn button-warning">Buy Now</a>
                  </div>
            </div>
            <div class="card shadow p-2 mt-2" id = "card-transform"  style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="db.php?meat" class="btn button btn button-warning">Buy Now</a>
                  </div>
            </div>
            ...
            <div class="card shadow p-2 mt-2" id = "card-transform" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="#" class="btn button btn button-warning">View offers</a>
                  </div>
            </div>
        </div>
