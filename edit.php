...
?>
		<form action = "db.php" method = "POST" class = "text-info">
			...
			<button type = "submit" class = "btn button btn button-primary col-lg-2" name = "savechanges">Edit</button>
			<a href = "db.php?back" class = "btn button btn button-danger col-lg-2">Cancel</a>
		</form>
	</div>
</div>
</div>
